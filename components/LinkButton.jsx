const LinkButton = ({
  ...
  return (
    <div className={`z-10 relative ${className}`}>
      <a
        className={`group relative w-full h-full inline-flex box-border items-center px-8 pt-3 pb-1 font-bold text-center text-white ${
          !bgColor
      ...
      >
        ...
        <span
          aria-hidden
          className={`absolute w-full h-full pt-3 pb-1 box-border  ${
            !bgColor
